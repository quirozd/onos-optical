...
import org.onosproject.net.intent.OpticalConnectivityIntent; //Edited
...
public class CodecManager implements CodecService {
    ...
    public void activate() {
        ...
        registerCodec(OpticalConnectivityIntent.class, new OpticalConnectivityIntentCodec()); //Edited
